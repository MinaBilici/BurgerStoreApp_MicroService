...
public class JwtTokenManager {
    ...
    public Optional<String> createToken(Long id) {
        ...
        try {
            ...
            throw new KullaniciServiceException(ErrorType.TOKEN_CREATION_FAILED);
        }
    ...
    public Optional<Long> getIdFromToken(String token) {
        try {
            ...
            throw new KullaniciServiceException(ErrorType.TOKEN_ARGUMENT_NOTVALID);
        }
        catch (JWTVerificationException e) {
            throw new KullaniciServiceException(ErrorType.TOKEN_VERIFY_FAILED);
        }
